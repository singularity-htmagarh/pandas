...
import pandas.core.window.indexer as indexer_custom
...
class Window(_Window):
    ...
    * ``exponential`` (needs tau), center is set to None.
    ...
    def validate(self):
        ...
        window = self.window
        if isinstance(window, (list, tuple, np.ndarray, indexer_custom.BaseIndexer)):
            pass
    ...
    def _prep_window(self, **kwargs):
        ...
        elif isinstance(window, indexer_custom.BaseIndexer):
    ...
    def validate(self):
        ...
        if (self.obj.empty or self.is_datetimelike) and isinstance(
            ...
            if self.min_periods is None:
                self.min_periods = 1
        elif isinstance(self.window, indexer_custom.BaseIndexer):
            pass
